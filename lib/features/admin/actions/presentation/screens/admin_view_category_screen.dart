...
class AdminViewCategoryScreen extends StatefulWidget {
  const AdminViewCategoryScreen({super.key});

  @override
  State<AdminViewCategoryScreen> createState() =>
      _AdminViewCategoryScreenState();
}

class _AdminViewCategoryScreenState extends State<AdminViewCategoryScreen> {
  @override
  void initState() {
    super.initState();
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push(AppRouter.adminAddCategory),
          ),
        ],
      ),
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: TextField(
                      onChanged: (value) {
                        context.read<ActionProvider>().searchCategories(value);
                      },
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Card(
                            child: InkWell(
                              onTap: () {
                                context.push(
                                    '${AppRouter.adminDetailCategory}/${category.id}');
                              },
                              child: Padding(
